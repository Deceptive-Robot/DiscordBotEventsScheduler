CREATE DATABASE  IF NOT EXISTS `discordbot` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `discordbot`;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci COMMENT='Contains all the events that are scheduled to take place and should be considered when informing users about them...';
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci COMMENT='The possible date/times for events. There can be many date and times that can be voted upon.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_0900_ai_ci COMMENT='Stores all the known servers along with their config details';
/*!40101 SET character_set_client = @saved_cs_client */;
